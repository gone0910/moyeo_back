...
- 여름(6월 1일 ~ 8월 31일): 실내 명소, 계곡, 해수욕장, 수영장, 야간 명소, 시원한 음식 위주로 구성.
...
- 200,000 ~ 299,999원: **게스트하우스만 사용 (전 일정 저가형 숙소)**
- 300,000 ~ 399,999원: **게스트하우스 1박 + 콘도·펜션 1박 (혼합형 구성)**
- 400,000 ~ 499,999원: **콘도·펜션만 사용 (중간 가격대 숙소)**
- 500,000 ~ 599,999원: **콘도·펜션 1박 + 호텔 1박 (혼합형 구성)**
- 600,000원 이상: **호텔·리조트 모두 사용 가능 (고급형 구성)**

     [숙소 규칙]
     - 형식: "지역(시/군/구) + 업종" 또는 "지역(시/군/구) + (실제 동/읍/면명) + 업종"
       - 예: "제주시 호텔", "서귀포시 리조트", "부산 해운대구 게스트하우스", "제주시 성산읍 펜션"
     - 허용 업종: 호텔, 리조트, 콘도, 펜션, 게스트하우스, 한옥스테이
